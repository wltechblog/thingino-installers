...
#https://github.com/themactep/thingino-firmware/releases/latest/download/thingino-wuuk_y0510_t31x_sc4336p_ssv6158.bin
#https://github.com/themactep/thingino-firmware/releases/latest/download/thingino-wuuk_y0510_t31x_sc401ai_ssv6158.binhttps://github.com/themactep/thingino-firmware/releases/latest/download/thingino-wuuk_y0510_t31x_sc401ai_ssv6158.bin
if grep sc4336p /mnt/backup/lsmod.txt
then
        echo "sc4336p" > /mnt/backup/model.txt
        update=/mnt/thingino-wuuk_y0510_t31x_sc4336p_ssv6158.bin
else
        echo "sc401ai" > /mnt/backup/model.txt
        update=/mnt/thingino-wuuk_y0510_t31x_sc401ai_ssv6158.bin
fi
sync

if [ ! -f $update ]
then
	echo "Missing update file, aborting" >> /mnt/backup/log
        umount /mnt
	exit
fi
