...
#        update=/mnt/thingino-wuuk_y0310_t41nq_sc401ai_ssv6158.bin
#else
...
dd if=/mnt/autoupdate-full.bin of=/mnt/u-boot-t41nq.bin bs=1k count=256

if [ -f /mnt/u-boot-t41nq.bin ] && [ -f /mnt/autoupdate-full.bin ]
then
	...
	echo "Flashing uboot"
	flashcp /mnt/u-boot-t41nq.bin /dev/mtd0
	echo "Rebooting"
        umount /mnt
	reboot
else
