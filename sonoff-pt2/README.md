...
# Installation 
1. Flash an SD card using the [Thingino Installer for the Sonoff PT2 camera](https://github.com/wltechblog/thingino-installers/tree/main/sonoff-pt2), and insert it into the camera.
